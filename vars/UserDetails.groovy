...
sh "curl -X GET -g http://18.224.172.87:8080/job/jenkins/api/json?tree=builds[id,result,changeSets[items[authorEmail]]] -u BhavyasriSana:bhavya1671 -o username.json"
